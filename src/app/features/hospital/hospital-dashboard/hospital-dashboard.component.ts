...
@Component({
  ...
  standalone: true,
  imports: [PatientVisitByDepartmentChartComponent, AveragePatientVisitChartComponent, PulseAnimationComponentComponent, PatientVisitByGenderChartComponent, MalePatientVistChartComponent, FemalePatientVistChartComponent],
